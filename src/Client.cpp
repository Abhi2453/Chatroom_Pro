	...
	while(1)
	{
        ...
        if(str[0]=='@'){
            ...
            if (pos != string::npos) {
                ...
                // Construct the private message format (or your defined protocol)
                string private_message = "@" + recipient + ":" + content;

                // Send the private message
                send(client_socket, private_message.c_str(), private_message.size(), 0);
            } else {
